...
REGISTERS: list[RegisterInfo] = [
    ...
    RegisterInfo(1054, "total_ac_charge_energy_grid_to_battery", "Total AC charge energy (grid to battery)", "Wh", "Float", "mdi:flash", "energy", 0),
    RegisterInfo(1056, "total_dc_pv_energy_sum_all_pv_inputs", "Total DC PV energy (sum of all PV inputs)", "Wh", "Float", "mdi:flash", "energy", 0),
    RegisterInfo(1058, "total_dc_energy_from_pv1", "Total DC energy from PV1", "Wh", "Float", "mdi:flash", "energy", 0),
    RegisterInfo(1060, "total_dc_energy_from_pv2", "Total DC energy from PV2", "Wh", "Float", "mdi:flash", "energy", 0),
    RegisterInfo(1062, "total_dc_energy_from_pv3", "Total DC energy from PV3", "Wh", "Float", "mdi:flash", "energy", 0),
    RegisterInfo(1064, "total_energy_ac_side_to_grid", "Total energy AC-side to grid", "Wh", "Float", "mdi:flash", "energy", 0),
    RegisterInfo(1066, "total_dc_power_sum_of_all_pv_inputs", "Total DC power (sum of all PV inputs)", "W", "Float", "mdi:flash", "power", 0),
    RegisterInfo(40346, "total_real_energy_exported", "Total Real Energy Exported", "Wh", "U32", "mdi:flash", "energy", 0),
    RegisterInfo(40354, "total_real_energy_imported", "Total Real Energy Imported", "Wh", "U32", "mdi:flash", "energy", 0),
]